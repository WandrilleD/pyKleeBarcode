...
if __name__ == "__main__" :
    ...
    parser = argparse.ArgumentParser(
                ...
                (heatmap-like visualisation of a sequence correlation measure).
                Note that for readability purpose the names of groups/species will only be written if there are less than 30.""")
    ...
    # printing values 
    if len(spList)<=ANNOTATION_THRESHOLD:
        texts = annotate_heatmap(im, valfmt="{x:.2f}" , fontsize=6)
